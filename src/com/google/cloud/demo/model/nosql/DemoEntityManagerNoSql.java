 ...
 * 
 * @param <T>
 *            type extends {@code DemoEntity}
 */
public abstract class DemoEntityManagerNoSql<T extends DemoEntity> implements
		DemoEntityManager<T> {
	private static final Logger logger = Logger
			.getLogger(DemoEntityManagerNoSql.class.getCanonicalName());
	...
	/**
	 * Down casts the entity to a NoSQL base entity. The method makes sure the
	 * entity is created by NoSQL datastore module.
	 * 
	 * @param demoEntity
	 *            the model entity.
	 * 
	...
	private DemoEntityNoSql downCastEntity(T demoEntity) {
		Utils.assertTrue(demoEntity instanceof DemoEntityNoSql,
				"entity has to be a valid NoSQL entity");
	 ...
	 */
	protected boolean checkEntityForDelete(DatastoreService ds,
			DemoEntityNoSql demoEntity) {
		if (demoEntity != null) {
