...
public class ConfigManager {
	private static final String ERROR_MESSAGE_DATASTORE_INDEX_NOT_READY = "The datastore index is not yet ready to serve. Please wait a minute and try to "
	...
	private static final String DEFAULT_ENTITY_MANAGER_FACTORY = "com.google.cloud.demo.model.nosql.DemoEntityManagerNoSqlFactory";
	...
	public String getErrorPageUrl(int code) {
		return "/error.jsp?" + ServletUtils.REQUEST_PARAM_NAME_CODE + "="
				+ code;
	}
	...
	/**
	 * The entity manager factory class. Depending on which class is chosen, the
	 * application will use either the NoSQL or Cloud SQL as the datstore for
	 * application data mode.
	 * 
	 */
	public String getDemoEntityManagerFactory() {
		String factoryClass = System
				.getProperty(PROP_NAME_ENTITY_MANAGER_FACTORY);
		return factoryClass == null ? DEFAULT_ENTITY_MANAGER_FACTORY
				: factoryClass;
	}
